...
const RestaurantCard = (props) => {
    ...
    return(
        <div className = "leading-relaxed w-[16vw] h-[42vh] bg-[#edf5f4] m-4 rounded-lg p-1 shadow-md transition-transform duration-100 ease-in-out hover:cursor-pointer hover:scale-90 text-black overflow-hidden" >
            <img  className="w-72 h-32 object-cover rounded-2xl p-1 pb-1" src ={CDN_URL + 
                ...
                <h4 className="text-sm font-serif font-normal ">{costForTwo}</h4>
                </div>
        </div>
